...
// model(task 1).cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Cmodeltask1App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание Cmodeltask1App

Cmodeltask1App::Cmodeltask1App()
{
...
// Единственный объект Cmodeltask1App

Cmodeltask1App theApp;


// Инициализация Cmodeltask1App

BOOL Cmodeltask1App::InitInstance()
{
